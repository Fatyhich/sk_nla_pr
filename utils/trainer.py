...
class ETTrainer:
    ...
    def test_descriptor(self):
        ...
        print("ET descriptor initialization for TIME TESTING...")
        ...
        self.model.calculate_parameters_time_test(obs_traj, pred_traj,
                                                  svd_method=self.args.svd,
                                                  cycle_number=self.args.test_svd)
    ...
    def init_descriptor(self):
        ...
        pred_traj = torch.cat([self.loader_train.dataset.pred_traj, self.loader_val.dataset.pred_traj], dim=0)
        obs_traj, pred_traj = augment_trajectory(obs_traj, pred_traj)
        self.model.calculate_parameters(obs_traj, pred_traj, svd_method=self.args.svd)
        print("Anchor generation...")
...
class ETSequencedMiniBatchTrainer(ETTrainer):
    ...
    def __init__(self, args, hyper_params):
        ...
        print(f'Chosed SVD method: {self.args.svd}')        

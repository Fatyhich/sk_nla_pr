...
if __name__ == '__main__':
    ...
    parser.add_argument('--svd', default="torch", type=str, help="Choose your preffered SVD method")
    parser.add_argument('--test_svd', default=None, type=int, help="Number of cycles")
